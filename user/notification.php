...
// Fetch user information including office
$user_query = "SELECT u.username, o.office_id, o.office_name 
               FROM users u 
...
<div class="header">
    <h1 class="page-title"><?php echo htmlspecialchars($page_title); ?> - <?php echo htmlspecialchars($office_name); ?></h1>
    <div class="user-profile">
        <div class="notification-icon" style="position: relative; margin-right: 10px;">
            ...
            <?php if ($notification_count > 0): ?>
                <span class="badge bg-danger notification-badge" style="position: absolute; top: -5px; right: -10px;">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                // Fetch notifications with feedback details for user's office
                $notifications_query = "
                ...
                $notifications_stmt->bind_param('i', $office_id);
